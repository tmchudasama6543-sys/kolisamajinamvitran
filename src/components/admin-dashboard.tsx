              ...
              <form id="admin-entry-form" onSubmit={handleSubmit(() => setShowConfirm(true))} className="space-y-5 sm:space-y-7">
                ...
                <FormField control={form.control} name="studentName" render={({ field }) => (
                  <FormItem className="space-y-2">
                    ...
                    <FormControl><Input placeholder="ઉ.દ. રામભાઈ પટેલ" {...field} className="h-14 font-black text-lg text-slate-900 rounded-2xl border-2 px-5 bg-slate-50/30" /></FormControl>
